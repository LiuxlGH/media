package com.mx.provider.htsf.render.gl
...
import com.mx.common.GlUtil.checkEglError
...
//        }
        eglSurface = null;//EGL14.EGL_NO_SURFACE
        eglContext = null;//EGL14.EGL_NO_CONTEXT
        eglDisplay = null;//EGL14.EGL_NO_DISPLAY
    }
}