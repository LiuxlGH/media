...
public class AnnexbHelper {
    ...
    * */
    ...
    public final static int NonIDR = 1;//	非IDR的片
    // Coded slice of an IDR picture slice_layer_without_partitioning_rbsp( )
    public final static int IDR = 5;//一个序列的第一个图像叫做 IDR 图像（立即刷新图像），IDR 图像都是 I 帧
    // Supplemental enhancement information (SEI) sei_rbsp( )
    public final static int SEI = 6;//补充增强信息单元（SEI）
    // Sequence parameter set seq_parameter_set_rbsp( )
    public final static int SPS = 7;//序列参数集(SPS)
    // Picture parameter set pic_parameter_set_rbsp( )
    public final static int PPS = 8;//图像参数集(PPS)
    // Access unit delimiter access_unit_delimiter_rbsp( )
    public final static int AccessUnitDelimiter = 9;//分界符
