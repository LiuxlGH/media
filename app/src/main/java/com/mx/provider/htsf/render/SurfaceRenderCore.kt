...
import com.mx.common.buildTextureId
import com.mx.common.createFloatBuffer
import com.mx.common.releaseTexture
import com.mx.common.unBindTexture
import com.mx.provider.htsf.config.VideoConfiguration
import com.mx.provider.htsf.encoder.VideoMediaCodec
import com.mx.provider.htsf.render.gl.*
import java.nio.ShortBuffer
import java.util.concurrent.Semaphore
import java.util.concurrent.TimeUnit

class SurfaceRenderCore(private val width: Int, private val height: Int) {
    private val TAG = "SurfaceRenderCore"
    private val eglEnv by lazy {
        EglEnv(width, height)re
    }
...
//        val codec = VideoMediaCodec.getVideoMediaCodec(videoConfig)
//        val surface = codec!!.createInputSurface()
    ...
    fun swapData(nesc: Long?) {
            eglEnv.setPresentationTime(System.nanoTime())
        eglEnv.swapBuffers()
    }

    private fun awaitNewImage() {
        if (!semaphore.tryAcquire(25000, TimeUnit.MILLISECONDS)) {
