...
public class GlUtil {
	...
	public static int createProgram(String vertexSource, String fragmentSource) {
		...
		if (linkStatus[0] != GLES20.GL_TRUE) {
			LogU.INSTANCE.e("Could not link program:");
			LogU.INSTANCE.e(GLES20.glGetProgramInfoLog(program));
	...
	public static int loadShader(int shaderType, String source) {
		...
		if (compiled[0] == 0) {
			LogU.INSTANCE.e(  "Could not compile shader(TYPE=" + shaderType + "):");
			LogU.INSTANCE.e(  GLES20.glGetShaderInfoLog(shader));
	...
	public static void checkGlError(String op) {
		...
		while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
			LogU.INSTANCE.e(  op + ": glGetError: 0x" + Integer.toHexString(error));
	...
	public static void checkEglError(String op) {
		...
		while ((error = EGL14.eglGetError()) != EGL14.EGL_SUCCESS) {
			LogU.INSTANCE.e(  op + ": eglGetError: 0x" + Integer.toHexString(error));
